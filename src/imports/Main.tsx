import svgPaths from "./svg-07d878p5y4";
...
import imgImage773 from "figma:asset/e046e282b8457b83537c12c2caa3ce5db22cc653.png";
import imgImage774 from "figma:asset/159543a71e9ce3bd58bed21494458061598b633c.png";
import imgImage775 from "figma:asset/a45cc75b826898bbc009e94d05fc8c1a4166e274.png";
import imgImage776 from "figma:asset/500ae47e4033e9f8617aaa76a8e65c5c08fa1b96.png";
import img1764173706506 from "figma:asset/1cc0a808a938657b6b76fb97ca7493baffcdda99.png";
import img1764173706511 from "figma:asset/a13bac3c61d4ff7bafdeb4b615aa814058691ce9.png";
import img1764173706491 from "figma:asset/55cf2beae7830d88372b6e2d29c0ce0e3eef7d7a.png";
import img1764173706502 from "figma:asset/eaff8af05addff1f6fe1bab29bc92303dac2138b.png";
import imgImage777 from "figma:asset/988711c1b7f61ab2eb7ce5f317a361bd0869f155.png";
import imgImage779 from "figma:asset/5be61ebcdf08ead577a5806dfda52eb12b0b0ac8.png";
import imgImage778 from "figma:asset/96b5d817231b9702ec32de278c0111a4522e9e45.png";
import imgImage780 from "figma:asset/eab1dbf924886552c4b155a6f8b7390cc22d7f18.png";
import { imgImage772 } from "./svg-fekxg";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Social icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_841)" id="Social icon">
...
function Frame18() {
  return <div className="[grid-area:1_/_1] bg-[#3c4242] h-[416px] ml-0 mt-0 rounded-[18.76px] w-[556px]" />;
}
...
function MaskGroup() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Mask group">
      <Frame18 />
      <div className="[grid-area:1_/_1] flex h-[453.844px] items-center justify-center ml-[-259px] mt-[-101px] relative w-[552.908px]" style={{ "--transform-inner-width": "487.59375", "--transform-inner-height": "260.90625" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[260.917px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[259px_101px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[487.599px]" data-name="image 772" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[30px] size-full" src={imgImage773} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[458.514px] items-center justify-center ml-[222.81px] mt-[-244.91px] relative w-[553.113px]" style={{ "--transform-inner-width": "484.296875", "--transform-inner-height": "267.828125" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[267.838px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-222.815px_244.913px] mask-size-[556px_416px] pointer-events-none relative rounded-[50px] w-[484.303px]" data-name="image 773" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[50px] size-full" src={imgImage774} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[50px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[462.893px] items-center justify-center ml-[-116px] mt-[138px] relative w-[543.231px]" style={{ "--transform-inner-width": "465.9375", "--transform-inner-height": "282.09375" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[282.109px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[116px_-138px] mask-size-[556px_416px] pointer-events-none relative rounded-[50px] w-[465.94px]" data-name="image 774" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[50px] size-full" src={imgImage775} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[50px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[444.406px] items-center justify-center ml-[349.58px] mt-[26.47px] relative w-[505.179px]" style={{ "--transform-inner-width": "422.53125", "--transform-inner-height": "283.46875" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[283.475px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-349.58px_-26.474px] mask-size-[556px_416px] pointer-events-none relative rounded-[50px] w-[422.538px]" data-name="image 775" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[50px] size-full" src={imgImage776} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[50px]" />
          </div>
        </div>
      </div>
...
function MaskGroup1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Mask group">
      <Frame19 />
      <div className="[grid-area:1_/_1] flex h-[447.015px] items-center justify-center ml-[270.83px] mt-[35.11px] relative w-[348.92px]" style={{ "--transform-inner-width": "183.640625", "--transform-inner-height": "408.109375" } as React.CSSProperties}>
        <div className="flex-none rotate-[27deg]">
          <div className="h-[408.12px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-270.835px_-35.113px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[183.654px]" data-name="1764173706506" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[30px] size-full" src={img1764173706506} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[447.015px] items-center justify-center ml-[202.98px] mt-[-247px] relative w-[348.92px]" style={{ "--transform-inner-width": "183.640625", "--transform-inner-height": "408.109375" } as React.CSSProperties}>
        <div className="flex-none rotate-[27deg]">
          <div className="h-[408.12px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-202.985px_247px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[183.654px]" data-name="1764173706511" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[30px] size-full" src={img1764173706511} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[447.015px] items-center justify-center ml-[-64px] mt-[-144.83px] relative w-[348.92px]" style={{ "--transform-inner-width": "183.640625", "--transform-inner-height": "408.109375" } as React.CSSProperties}>
        <div className="flex-none rotate-[27deg]">
          <div className="h-[408.12px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[64px_144.832px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[183.654px]" data-name="1764173706491" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[30px] size-full" src={img1764173706491} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[447.015px] items-center justify-center ml-[12.36px] mt-[126.94px] relative w-[348.92px]" style={{ "--transform-inner-width": "183.640625", "--transform-inner-height": "408.109375" } as React.CSSProperties}>
        <div className="flex-none rotate-[27deg]">
          <div className="h-[408.12px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-12.358px_-126.94px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[183.654px]" data-name="1764173706502" style={{ maskImage: `url('${imgImage772}')` }}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[30px] size-full" src={img1764173706502} />
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
...
function MaskGroup2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Mask group">
      <Frame20 />
      <div className="[grid-area:1_/_1] flex h-[334.774px] items-center justify-center ml-[-102px] mt-[-30.29px] relative w-[368.697px]" style={{ "--transform-inner-width": "300.3125", "--transform-inner-height": "222.6875" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[222.702px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[102px_30.291px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[300.326px]" data-name="image 776" style={{ maskImage: `url('${imgImage772}')` }}>
            <div className="absolute inset-0 overflow-hidden rounded-[30px]">
              <img alt="" className="absolute h-full left-[-9.38%] max-w-none top-0 w-[118.65%]" src={imgImage777} />
            </div>
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[334.769px] items-center justify-center ml-[317.29px] mt-[119.86px] relative w-[368.709px]" style={{ "--transform-inner-width": "300.34375", "--transform-inner-height": "222.671875" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[222.686px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-317.291px_-119.862px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[300.347px]" data-name="image 779" style={{ maskImage: `url('${imgImage772}')` }}>
            <div className="absolute inset-0 overflow-hidden rounded-[30px]">
              <img alt="" className="absolute h-full left-[-9.5%] max-w-none top-0 w-[118.63%]" src={imgImage779} />
            </div>
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[323.428px] items-center justify-center ml-[219.68px] mt-[-70.29px] relative w-[362.288px]" style={{ "--transform-inner-width": "299.359375", "--transform-inner-height": "210.4375" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[210.453px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-219.681px_70.289px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[299.374px]" data-name="image 777" style={{ maskImage: `url('${imgImage772}')` }}>
            <div className="absolute inset-0 overflow-hidden rounded-[30px]">
              <img alt="" className="absolute h-[105.39%] left-[-9.45%] max-w-none top-[-2.58%] w-[118.59%]" src={imgImage778} />
            </div>
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
      </div>
      <div className="[grid-area:1_/_1] flex h-[334.929px] items-center justify-center ml-[2.06px] mt-[172.07px] relative w-[368.994px]" style={{ "--transform-inner-width": "300.640625", "--transform-inner-height": "222.6875" } as React.CSSProperties}>
        <div className="flex-none rotate-[333deg]">
          <div className="h-[222.708px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.063px_-172.071px] mask-size-[556px_416px] pointer-events-none relative rounded-[30px] w-[300.656px]" data-name="image 778" style={{ maskImage: `url('${imgImage772}')` }}>
            <div className="absolute inset-0 overflow-hidden rounded-[30px]">
              <img alt="" className="absolute h-full left-[-9.31%] max-w-none top-0 w-[118.52%]" src={imgImage780} />
            </div>
            <div aria-hidden="true" className="absolute border-[3px] border-black border-solid inset-0 rounded-[30px]" />
          </div>
        </div>
