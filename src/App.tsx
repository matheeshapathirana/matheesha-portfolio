...
export default function App() {
  ...
  const skillTileStyle = { width: "min(186px, 42vw)", height: "min(186px, 42vw)" };
  const skillLabelStyle = { fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: "clamp(1rem, 3vw, 20px)" };

  // Removed dynamic hero JS positioning; using CSS spacer method instead.
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 bg-[#0b0b0b] z-50 shadow-lg shadow-black/20">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-end gap-4 sm:gap-6 lg:gap-12 px-4 sm:px-8">
          <button
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#0b0b0b] border-t border-white/10 px-4 pb-4">
            <button
              onClick={() => scrollToSection("about")}
              className="block w-full text-left text-white hover:bg-gray-800 px-4 py-3 text-sm font-semibold tracking-wide"
            >
              About me
            </button>
            <button
      ...
      {/* Hero Section */}
      <section id="hero-section" className="relative bg-[#d7d7d7] min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden z-0">
          <div className="absolute right-[-10%] top-[-5%] w-[120%] md:w-[100%] lg:w-[80%] h-full">
            <div className="relative w-full h-full flex items-center justify-center">
              <div className="absolute w-full aspect-square max-w-[600px] lg:max-w-[856px]" style={{ transform: 'translateY(380px)' }}>
              ...
              <div className="absolute w-full max-w-[600px] lg:max-w-[857px]" style={{ bottom: '-80px' }}>
                <img id="hero-photo" alt="" className="w-full h-auto" src={imgTransparent1} />
              </div>
            </div>
          </div>
        </div>
        {/* Dynamic positioned content */}
        <HeroContent />
      </section>
      ...
      <section id="skills" className="bg-black py-12 md:py-20 lg:py-24 px-4 md:px-8">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-white text-center mb-8 md:mb-12">
            <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>My </span>
            <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>Skills</span>
          </h2>

          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto">
            {/* Git */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
                <path d={svgPaths.p22f18480} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>Git</p>
            </div>

            {/* JavaScript */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16" fill="none" preserveAspectRatio="none" viewBox="0 0 56  56">
                <path d={svgPaths.p1e87680} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>JavaScript</p>
            </div>

            {/* Python */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16" fill="none" preserveAspectRatio="none" viewBox="0 0 59 58">
                <path d={svgPaths.p3be0de00} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>Python</p>
            </div>

            {/* Java */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-10 h-14 md:w-12 md:h-16 lg:w-14 lg:h-18" fill="none" preserveAspectRatio="none" viewBox="0 0 51 69">
                <path d={svgPaths.p25e5ddc0} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>Java</p>
            </div>

            {/* HTML */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-10 h-12 md:w-11 md:h-12 lg:w-12 lg:h-14" fill="none" preserveAspectRatio="none" viewBox="0 0 46 54">
                <path d={svgPaths.p1566cd80} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>HTML</p>
            </div>
            ...
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg
                ...
                viewBox="0 0 50 51"
                style={{ width: 'clamp(2rem, 7vw, 3.1rem)', height: 'auto' }}
              >
                <path d={svgPaths.p17b57b00} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>CSS</p>
            </div>

            {/* MySQL */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-10 h-14 md:w-14 md:h-16 lg:w-16 lg:h-18" fill="none" preserveAspectRatio="none" viewBox="0 0 57 64">
                <path d={svgPaths.p29b29580} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>MySQL</p>
            </div>

            {/* C */}
            <div className="bg-white border-2 border-black rounded flex flex-col items-center justify-center gap-4 flex-none" style={skillTileStyle}>
              <svg className="w-10 h-12 md:w-12 md:h-14 lg:w-14 lg:h-16" fill="none" preserveAspectRatio="none" viewBox="0 0 52 60">
                <path d={svgPaths.p1cd680} fill="black" />
              </svg>
              <p className="text-center text-black" style={skillLabelStyle}>C</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="w-full lg:flex-1">
              <h2 className="text-black mb-6 text-center lg:text-left">
                <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(2rem, 6vw, 48px)' }}>About </span>
                <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2rem, 6vw, 48px)' }}>Me</span>
              </h2>

              <div className="text-zinc-500 space-y-4 mb-8 text-sm sm:text-base md:text-lg leading-relaxed">
                <p>
      ...
      <section id="portfolio" className="bg-black py-8 md:py-12 lg:py-16 px-4 md:px-8">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-white text-center mb-8 md:mb-16">
            <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>My </span>
            <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>Projects</span>
          </h2>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 mb-12 lg:mb-20">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <p className="text-white mb-2 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.5rem, 8vw, 48px)' }}>01</p>
              <h3 className="text-white mb-3 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 'clamp(1.5rem, 5vw, 32px)' }}>Track n Go (Logistics Management System)</h3>
              <p className="text-zinc-500 mb-6" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(1rem, 3.2vw, 18px)' }}>
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-8 lg:gap-10 mb-12 lg:mb-20">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <p className="text-white mb-2 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.5rem, 8vw, 48px)' }}>02</p>
              <h3 className="text-white mb-3 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 'clamp(1.5rem, 5vw, 32px)' }}>Flixer (Java Android App)</h3>
              <p className="text-zinc-500 mb-6" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(1rem, 3.2vw, 18px)' }}>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <p className="text-white mb-2 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.5rem, 8vw, 48px)' }}>03</p>
              <h3 className="text-white mb-3 md:mb-4" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: 'clamp(1.5rem, 5vw, 32px)' }}>Deskshop (E-Commerce Website)</h3>
              <p className="text-zinc-500 mb-6" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(1rem, 3.2vw, 18px)' }}>
            ...
            <div className="w-full lg:w-1/2">
              <form onSubmit={onSubmit} className="space-y-5">
                ...
                <div className="flex flex-wrap gap-4 sm:gap-6 items-center">
                  <button 
                    type="submit"
                    className="bg-black text-white px-8 py-4 rounded hover:bg-gray-800 transition-colors w-full sm:w-auto text-center"
                    style={{ fontFamily: "'Sora', sans-serif", fontWeight: 600, fontSize: 'clamp(1rem, 3.2vw, 20px)' }}
                  >
                    Get In Touch
                  </button>

                  <div className="flex flex-wrap gap-4 md:gap-6">
                    <a href="https://www.facebook.com/profile.php?id=100071367609736" target="_blank" rel="noopener noreferrer" className="bg-black rounded hover:bg-gray-800 transition-colors flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
                      <svg className="w-5 h-5" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                    ...
                    <a href="https://www.linkedin.com/in/matheesha-pathirana" target="_blank" rel="noopener noreferrer" className="border-2 border-black rounded hover:bg-black hover:text-white transition-colors group flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
                    ...
                    <a href="https://x.com/matheesha_pathi" target="_blank" rel="noopener noreferrer" className="border-2 border-black rounded hover:bg-black hover:text-white transition-colors group flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
                      <svg className="w-5 h-5" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                    ...
                    <a href="https://discord.com/users/975373598778875924" className="border-2 border-black rounded hover:bg-black hover:text-white transition-colors group flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
                    ...
                    <a href="https://www.reddit.com/user/matheesha-pathirana" target="_blank" rel="noopener noreferrer" className="border-2 border-black rounded hover:bg-black hover:text-white transition-colors group flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
                      <svg className="w-6 h-6" viewBox="0 0 640 640">
              ...
              <div className="space-y-6 md:space-y-10">
                <div>
                  <h2 className="text-black mb-6 leading-tight">
                    <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>Let’s </span>
                    <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)', WebkitTextStroke: '1px black', WebkitTextFillColor: 'transparent', letterSpacing: '0.04em' }}>talk</span>
                    <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}> for</span>
                    <br />
                    <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 'clamp(2.25rem, 7vw, 48px)' }}>Something special</span>
                  </h2>
                </div>

                <p className="text-zinc-500 text-base md:text-lg" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 400, fontSize: 'clamp(1rem, 3.5vw, 16px)' }}>
                ...
                <a href="mailto:pathiranamatheesha@gmail.com" className="text-black break-all hover:underline" style={{ fontFamily: "'Sora', sans-serif", fontWeight: 600, fontSize: 'clamp(1.5rem, 5vw, 28px)' }}>pathiranamatheesha@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
...
function HeroContent() {
  ...
  const sectionRef = useRef<HTMLElement | null>(document.getElementById('hero-section'));
  const [top, setTop] = useState<string>('60vh');
  const [viewportWidth, setViewportWidth] = useState(() => (typeof window === 'undefined' ? 1024 : window.innerWidth));
  const heroLift = viewportWidth < 768 ? 'clamp(360px, 65vw, 520px)' : 'clamp(80px, 14vw, 320px)';
  const iconDrop = 'clamp(2.5rem, 7vw, 140px)';

  useEffect(() => {
    const recalc = () => {
      const imgEl = document.getElementById('hero-photo') as HTMLImageElement | null;
      if (!imgEl || !sectionRef.current || !containerRef.current) return;
      const imgRect = imgEl.getBoundingClientRect();
      const sectionRect = sectionRef.current.getBoundingClientRect();
      // Responsive tuning: mobile keeps higher level, desktop slightly lower per design
      const w = window.innerWidth;
      setViewportWidth((prev) => (prev === w ? prev : w));
      let headFactor: number;
      let offsetUpPx: number;
      let minRatio: number;
      let mobileBoost = 0; // allows pushing content higher on small screens
      if (w >= 1024) { // large desktop: push content even further DOWN
        // Use a larger target ratio for deeper placement
        const desktopTargetRatio = 0.60; // 60% from top of hero section
        headFactor = 0.32; // fallback relation to image if needed
        offsetUpPx = 180;  // stronger downward push
        minRatio = 0.24;
        let ratioY = sectionRect.height * desktopTargetRatio;
        let headBased = imgRect.top - sectionRect.top + imgRect.height * headFactor + offsetUpPx;
        // Choose the deeper of the two (ratio vs head-based)
        let chosen = Math.max(headBased, ratioY);
        // Cap so we don't collide with bottom; allow more depth than before
        const maxY = sectionRect.height * 0.80; // 80% cap
        if (chosen > maxY) chosen = maxY;
        const minYDesk = sectionRect.height * minRatio;
        if (chosen < minYDesk) chosen = minYDesk;
        setTop(chosen + 'px');
        return; // skip rest of calc path
      } else if (w >= 768) { // tablet / mid
        headFactor = 0.10;
        offsetUpPx = -170;
        minRatio = 0.12;
      } else { // mobile
        ...
        offsetUpPx = -260;
        minRatio = 0.08;
        mobileBoost = 120; // lift content higher so it sits nearer to the headshot
      }
      let desiredY = imgRect.top - sectionRect.top + imgRect.height * headFactor + offsetUpPx;
      if (mobileBoost > 0) {
        desiredY -= mobileBoost;
      }
      const minY = sectionRect.height * minRatio;
  ...
  return (
    <div
      ref={containerRef}
      className="absolute inset-x-0 z-30 px-4 md:px-8 lg:px-16 mx-auto max-w-2xl transition-[top] duration-300"
      style={{ top: `calc(${top} - ${heroLift})`, left: 'clamp(0rem, 6vw, 140px)' }}
    >
      <div className="relative">
        <p
          className="text-black mb-0"
          style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: 'clamp(1.75rem,5vw,40px)', marginTop: 0, lineHeight: 1 }}
        >
          Hi, I'm
        </p>
        <h1
          className="text-black leading-none mb-0"
          style={{
            fontFamily: "'Raleway', sans-serif",
            fontWeight: 700,
            fontSize: 'clamp(3rem,11vw,80px)',
            marginTop: 0,
            lineHeight: 1,
            marginLeft: 'clamp(0.25rem, 2vw, 32px)'
          }}
        >
          Matheesha Pathirana
        </h1>
        <p
          className="text-[#909090] mb-6 sm:mb-8 md:mb-10"
          style={{
            fontFamily: "'Raleway', sans-serif",
            fontWeight: 800,
            fontSize: 'clamp(1.25rem,4vw,25px)',
            marginLeft: 'clamp(0.25rem, 2vw, 32px)',
            textAlign: 'left'
          }}
        >
      ...
      <div className="flex flex-wrap gap-4 md:gap-6" style={{ marginTop: iconDrop }}>
        <a href="https://www.facebook.com/profile.php?id=100071367609736" target="_blank" rel="noopener noreferrer" className="bg-black rounded hover:bg-gray-800 transition-colors flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
          <svg className="w-5 h-5" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <g clipPath="url(#clip0_dynamic_fb)">
              <path d={svgPaths.p24dd3180} fill="white" />
            </g>
            <defs>
              <clipPath id="clip0_dynamic_fb">
                <rect fill="white" height="20" width="20" />
              </clipPath>
            </defs>
          </svg>
        ...
        <a href="https://x.com/matheesha_pathi" target="_blank" rel="noopener noreferrer" className="border-2 border-black rounded hover:bg-black hover:text-white transition-colors group flex items-center justify-center w-12 h-12 md:w-14 md:h-14">
          <svg className="w-5 h-5" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <g clipPath="url(#clip0_dynamic_x)">
              <path d={svgPaths.p208c440} fill="black" className="group-hover:fill-white" />
            </g>
            <defs>
              <clipPath id="clip0_dynamic_x">
                <rect fill="white" height="20" width="20" />
              </clipPath>
            </defs>
          </svg>
